...
ATANCamera::ATANCamera(string sName) : msName(std::move(sName)) {
...
void ATANCamera::RefreshParams() {
  ...
  // parameters, and the currently selected target image size.
...
Matrix<2, 2> ATANCamera::GetProjectionDerivs() {
  ...
  // projection in the form (d im1/d cam1, d im1/d cam2)
