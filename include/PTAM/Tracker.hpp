...
public:
  ...
  */
  ...
  /** 
  * @brief TrackFrame is the main working part of the tracker: call this every frame.
  * 
  * @param imFrame
  * @param bDraw
  */
...
protected:
  ...
  */
  ...
  int TrailTracking_Advance(); // Steady-state of initial trail tracking. Called
                               // by TrackForInitialMap.
  ...
  Vector<6>
  CalcPoseUpdate(std::vector<TrackerData *> vTD, double dOverrideSigma = 0.0,
