...
namespace PTAM {
/**
 * @brief Homography matches are 2D-2D matches in a stereo pair, unprojected to
 * the Z=1 plane.
 */
...
/**
 * @brief Storage for each homography decomposition
 */
...
public:
  ...
  * 
  * @param vMatches
  * @param dMaxPixelError
  * @param se3SecondCameraPose
  * 
  * @return 
  */
