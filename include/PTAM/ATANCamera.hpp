...
#ifndef __ATAN_CAMERA_HPP
#define __ATAN_CAMERA_HPP
...
public:
  ...
  */
  ...
  /** 
  * @brief Image size get/set:
  * updates the internal projection params to that target image size.
  * 
  * @param v2ImageSize
  */
  ...
  * @return 
  */
  Vector<2> GetImageSize() const { return mvImageSize; }
  ...
  */
  ...
  /** 
  * @brief Various projection functions
  * Projects from camera z=1 plane to pixel coordinates,
  ...
  * @return 
  */
  Vector<2> Project(CVD::ImageRef ir) { return Project(vec(ir)); }
  ...
  * @return 
  */
  Vector<2> UnProject(CVD::ImageRef ir) { return UnProject(vec(ir)); }
  ...
  * @return 
  */
  bool Invalid() const { return mbInvalid; }
  ...
  * @return 
  */
  double LargestRadiusInImage() const { return mdLargestRadius; }
  ...
  * @return 
  */
  double OnePixelDist() const { return mdOnePixelDist; }

  /** 
  * @brief The z=1 plane bounding box of what the camera can see
  * 
  * @return 
  */
  Vector<2> ImplaneTL();
  ...
  */
  ...
  /** 
  * @brief Feedback for Camera Calibrator
  * 
  * @return 
  */
  ...
  /** 
  * @brief Useful for gvar-related reasons
  * (in case some external func tries to read
...
protected:
  ...
  */
  ...
  double mdDistortionEnabled; // One or zero depending on if distortion is on or
                              // off.
  ...
  /** 
  * @brief Radial distortion transformation factor:
  * returns ration of distorted / undistorted radius.
  * 
  * @param r
  * 
  * @return 
  */
  double rtrans_factor(double r) const {
    if (r < 0.001 || mdW == 0.0) {
      return 1.0;
    } else {
  ...
  /** 
  * @brief Inverse radial distortion:
  * returns un-distorted radius from distorted.
  * 
  * @param r
  * 
  * @return 
